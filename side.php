...
<input id="sidebtn" class="d-none" type="checkbox">
<div class="col-lg-2 col-md-3 col-sm-4" id="side" style="background-color:  #FAFFC1; height:100%; ">
        <div class="d-flex justify-content-between">
          <h2 class="fw-bold fs-6 p-2"><span class="border-start pe-2 border-4 border-info"></span>E-classe</h1>
          <label  for="sidebtn" class="flex-end" id="deskbtn"  href=""><img src="vector (1).png" alt=""></label>
        </div>
        <div class="img pt-3">
